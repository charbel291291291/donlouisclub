    ...
    >
      ...
      <div className="space-y-8">
        {visibleItems.map((item, idx) => {
          ...
          const isTodaysPick =
            isHighlighted && adminSettings.highlightTag === "Today's Pick";
              ...
              <div className="p-6 -mt-16 relative z-10">
                <h3
                  className={`text-xl font-serif mb-2 ${
                    isTodaysPick ? "text-gold-metallic" : "text-white"
                  }`}
                >
                  {item.nameEn}
                </h3>
                ...
                <div className="flex justify-between items-center border-t border-white/5 pt-4">
                  <p className="text-[10px] font-arabic text-zinc-600">
                    {item.nameAr}
                  </p>
                  <p className="text-sm font-bold text-[#E5C579] font-serif tracking-wider">
                    ${item.price}
                  </p>
                </div>
              </div>
      ...
      <div className="mt-16 text-center opacity-30">
        ...
        <p className="text-[6px] text-zinc-500 mt-2">Full Menu at Location</p>
      </div>
    </motion.div>
  );
};
