  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        >
          <div className="group">
            <label className="block text-[9px] font-bold uppercase tracking-widest text-zinc-600 mb-2 transition-colors group-focus-within:text-[#BF953F]">
              First Name
            </label>
            <input
              type="text"
            ...
            <div
              className={`w-8 h-8 rounded-full border flex items-center justify-center shrink-0 transition-colors ${
                followed
                  ...
                  : "border-zinc-700 text-zinc-700 group-hover:border-zinc-500"
              }`}
            >
              {followed ? (
            ...
            <div className="flex-1">
              <p
                className={`text-xs font-bold uppercase tracking-wide mb-0.5 ${
                  followed ? "text-[#E5C579]" : "text-zinc-300"
                }`}
              >
                Follow Instagram
              </p>
      ...
      >
        <p className="text-[10px] text-zinc-500 font-serif italic tracking-wider">
          {BRAND_TAGLINE}
        </p>
      </motion.div>
    </motion.div>
