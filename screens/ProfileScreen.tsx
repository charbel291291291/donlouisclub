      ...
      case MembershipTier.PLATINUM:
        return (
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(115deg, transparent 30%, rgba(255,255,255,0.4) 45%, rgba(255,255,255,0.6) 50%, rgba(255,255,255,0.4) 55%, transparent 70%)",
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Logo Watermark */}
              <div
                className="absolute inset-0 flex items-center justify-center opacity-[0.15] mix-blend-soft-light pointer-events-none"
              ...
              >
                <div className="relative w-56 h-56 rounded-full border-[3px] border-white/60 flex flex-col items-center justify-center p-4">
                  ...
                  <img
                    ...
                    alt="Don Louis Logo"
                  />
                  <h2 className="font-serif text-3xl text-white font-bold italic tracking-tighter">
                    Don Louis
                  </h2>
                  <div className="w-full h-px bg-white/40 my-1 w-24" />
                  <p className="text-[6px] uppercase tracking-[0.2em] text-white font-bold">
                    Where Food Is An Art
                  </p>
                  <p className="text-[5px] uppercase tracking-widest text-white/80 mt-2">
                    Snack-Bar & Grill
                  </p>
                </div>
              </div>
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center bg-white/5 backdrop-blur-md shadow-inner">
                      <span
                        className={`font-serif text-sm font-bold ${config.textColor}`}
                      >
                        DL
                      </span>
                    </div>
                    <Wifi
                      size={20}
                      className="text-white/40 rotate-90 drop-shadow-md"
                    />
                  </div>

                  <div className="text-right">
                    <p className="text-[7px] text-white/50 uppercase tracking-[0.3em] font-bold mb-1">
                      Tier
                    </p>
                    <div
                      className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full backdrop-blur-md border border-white/10 ${
                    ...
                    >
                      ...
                      {currentTier === MembershipTier.BRONZE && (
                        <Star size={10} className="text-[#ECAE7D]" />
                      )}

                      <p
                        className={`text-[9px] font-black tracking-widest uppercase ${config.textColor}`}
                      >
                        {config.badge}
                      </p>
                    </div>
                ...
                <div className="my-auto transform translate-z-10">
                  <h2
                    className={`text-3xl font-serif tracking-tight ${config.textColor} drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]`}
                  >
                    {config.nameEn}
                  </h2>
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-[7px] text-white/40 uppercase tracking-widest mb-1">
                      Member Name
                    </p>
                  ...
                  <div className="text-right">
                    <div className="flex items-center justify-end gap-1 mb-1 opacity-50">
                      ...
                      <span className="text-[7px] text-white font-bold uppercase tracking-widest">
                        Tap to Scan
                      </span>
                    </div>
        ...
        <div className="flex justify-between items-end mb-3">
          ...
          <p className="text-xs font-serif text-[#E5C579]">
            ...
            <span className="text-zinc-700 font-sans">
              / {points >= 24 ? "∞" : nextTierDetails.target} pts
            </span>
          </p>
        </div>
        ...
        <div className="relative rounded-2xl overflow-hidden bg-[#0A0A0A] border border-zinc-800/50 group shadow-lg">
          {currentTier === MembershipTier.PLATINUM ? (
              ...
              <div className="p-4 flex flex-col justify-center relative z-20">
                <div className="flex items-center gap-1.5 mb-1">
                  <Crown
                    ...
                    fill="currentColor"
                  />
                  <h3 className="text-[#E5C579] font-serif text-sm font-bold">
                    {SECRET_MENU_ITEM.nameEn}
                  </h3>
                </div>
                <p className="text-zinc-500 text-[9px] leading-relaxed mb-0">
                  {SECRET_MENU_ITEM.descEn}
                </p>
              </div>
            </div>
          ) : (
            <div className="relative h-28 w-full flex items-center justify-center overflow-hidden">
              <img
                src={SECRET_MENU_ITEM.image}
                className="absolute inset-0 w-full h-full object-cover blur-lg opacity-10"
              />
